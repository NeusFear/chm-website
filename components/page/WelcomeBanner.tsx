    ...
    return (
        <div className="w-screen h-96 relative">
            ...
            <div className="bg-gray-900 bg-opacity-70 absolute w-full h-full top-0 text-white text-center flex flex-col place-content-center">
                ...
                <p className="text-xl">Your local source for Retail, Custom Processed Meats, <br />and Inspected Slaughter in Central Oklahoma. <br /> WE WILL BE CLOSED JULY 3RD THROUGH JULY 12TH FOR VACATION. </p>                
            </div>
        </div>
    );
}
